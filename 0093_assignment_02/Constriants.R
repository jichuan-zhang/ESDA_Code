...
indonesia_avilable_sv = vect(indonesia_avilable)
constrained_area = mask(raster_template, indonesia_avilable_sv)

writeRaster(constrained_area, "constrained_area.tif")
